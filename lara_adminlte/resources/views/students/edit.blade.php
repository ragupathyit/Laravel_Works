...
<div class="content-wrapper" style="margin-top: 50px;">
    ...
    <section class="content">
      ...
      <div class="box box-info">
        ...
        <!-- form start -->
        <form class="form-horizontal" action="{{ route('students.update', $lists->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="regno" value="{{ $lists->regno }}" id="inputregno" placeholder="Register No">
                        @if ($errors->has('regno'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="sname" value="{{ $lists->sname }}" id="inputsname" placeholder="Student Name">
                        @if ($errors->has('sname'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="class" value="{{ $lists->class }}" id="inputclass" placeholder="Class">
                        @if ($errors->has('class'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="age" value="{{ $lists->age }}" min="0" max="99" maxlength="2" id="inputage" placeholder="Age">
                        @if ($errors->has('age'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <img src="/images/{{ $lists->simage }}" width="80px" height="80px">
            ...
            <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info pull-right"><i class="fa fa-check" aria-hidden="true"></i> Update</button>
            </div>
            <!-- /.box-footer-->
        </form>
      </div>
